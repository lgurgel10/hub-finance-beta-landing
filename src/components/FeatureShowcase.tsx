...
const FeatureShowcase = () => {
  return (
    <div className="py-24 bg-dark-700" id="funcionalidades">
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="dashboard" className="w-full">
          <TabsList className="grid w-full grid-cols-1 md:grid-cols-3 bg-dark-400/50 p-1">
            <TabsTrigger value="dashboard">Dashboard Intuitivo</TabsTrigger>
                ...
                <div className="relative bg-dark-600 border border-mint-500/30 rounded-xl p-1 overflow-hidden">
                  <div className="bg-dark-500 rounded-lg p-4 h-[340px] overflow-hidden">
                    <div className="h-full w-full bg-dark-400 rounded-md flex items-center justify-center">
                      <p className="text-mint-400">Prévia do Dashboard</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="assinaturas" className="mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-dark-600 border border-mint-500/30 rounded-xl p-1 overflow-hidden">
                  <div className="bg-dark-500 rounded-lg p-4 h-[340px] overflow-hidden">
                    <div className="h-full w-full bg-dark-400 rounded-md flex items-center justify-center">
                      <p className="text-mint-400">Prévia de Gestão de Assinaturas</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="colaboracao" className="mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-dark-600 border border-mint-500/30 rounded-xl p-1 overflow-hidden">
                  <div className="bg-dark-500 rounded-lg p-4 h-[340px] overflow-hidden">
                    <div className="h-full w-full bg-dark-400 rounded-md flex items-center justify-center">
                      <p className="text-mint-400">Prévia de Colaboração</p>
                    </div>
                  </div>
                </div>
              </div>
