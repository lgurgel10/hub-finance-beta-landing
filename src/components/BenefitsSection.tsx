...
import { PieChart, BarChart, ListCheck } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-dark-500/50 border border-mint-500/10 p-6 hover:border-mint-500/30 transition-all duration-300">
