        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4">
              Controle financeiro <span className="text-gradient">completo</span> para você e seu negócio
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl">
              Simplifique sua gestão financeira com um dashboard intuitivo para monitorar receitas, despesas e assinaturas. Tudo em um só lugar.
            </p>
            ...
            <div className="mt-10 flex items-center gap-3">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="h-8 w-8 rounded-full border-2 border-dark-700 bg-dark-300 flex items-center justify-center text-xs font-medium">
                    {i === 4 ? '+' : ''}
                  </div>
                ))}
              </div>
